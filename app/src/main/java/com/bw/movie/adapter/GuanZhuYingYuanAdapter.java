...
public class GuanZhuYingYuanAdapter extends BaseRecyclerAdapter<GuanZhuYingYuan.ResultBean> {
    public GuanZhuYingYuanAdapter(Context context) {
        super(context);
    ...
    @Override
    public void bindViewDataPosition(BaseViewHolder baseViewHolder, GuanZhuYingYuan.ResultBean resultBean, int i) {
    ...
    @Override
    public void bindViewData(BaseViewHolder baseViewHolder, GuanZhuYingYuan.ResultBean resultBean) {
