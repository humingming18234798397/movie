...
public class PriceAdapter extends BaseRecyclerAdapter<PriceBean.ResultBean> {
    ...
    @Override
    public void bindViewDataPosition(BaseViewHolder baseViewHolder, PriceBean.ResultBean resultBean, int i) {
    ...
    @Override
    public void bindViewData(BaseViewHolder baseViewHolder, PriceBean.ResultBean resultBean) {
