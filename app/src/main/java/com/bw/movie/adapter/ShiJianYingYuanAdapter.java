...
public class ShiJianYingYuanAdapter extends BaseRecyclerAdapter<ShiJianYingYuanBean.ResultBean> {
    public ShiJianYingYuanAdapter(Context context) {
        super(context);
    ...
    @Override
    public void bindViewDataPosition(BaseViewHolder baseViewHolder, ShiJianYingYuanBean.ResultBean resultBean, int i) {
        ...
        baseViewHolder.setText(R.id.yingyuan_item1_juli,resultBean.getPrice()+"元");
    ...
    @Override
    public void bindViewData(BaseViewHolder baseViewHolder, ShiJianYingYuanBean.ResultBean resultBean) {
